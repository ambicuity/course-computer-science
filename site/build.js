#!/usr/bin/env node
/**
 * Build script for Course: Computer Science website.
...
const GITHUB_BASE = 'https://github.com/ambicuity/course-computer-science/tree/main/';
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (inLessonTable && currentPhase && line.startsWith('|')) {
      ...
      if (cols.length >= 4) {
        ...
        // Note: in course-computer-science, every lesson has a scaffolded URL even
        // when its body is still a stub. ROADMAP.md is the authoritative source for
        // lesson status — do NOT promote planned → complete based on link presence.
